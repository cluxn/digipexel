	...
	return (
		<footer className="relative w-full border-t border-border-subtle bg-surface mt-24">
			...
			<div className="mx-auto max-w-7xl px-6 pt-16 pb-12 lg:px-8 lg:pt-20 lg:pb-16">
				...
				{/* ── Bottom bar — single line: copyright | credit | legal ── */}
				<div className="mt-14 pt-6 border-t border-border-subtle/60 flex flex-col gap-3 sm:gap-0 sm:flex-row sm:items-center sm:justify-between">
