...
export const DEFAULT_SECTIONS = {
  ...
  roadmapItems: [
    { step: "01", title: "Discovery", desc: "We audit your current stack, map every manual handoff, and define the highest-ROI automation targets. Output: a prioritised scope doc signed off by your team." },
    { step: "02", title: "Architecture", desc: "We design the full workflow logic — triggers, decision branches, data models, and tool selection. Every dependency is documented before a single line ships." },
    { step: "03", title: "Engineering", desc: "Agents, integrations, and data pipelines are built in parallel sprints with daily progress visibility. You see working demos, not status slides." },
    { step: "04", title: "Validation", desc: "Load testing, edge-case simulation, and a full security audit run before anything touches production. Zero shortcuts on the quality gate." },
    { step: "05", title: "Deployment", desc: "Workflows go live in a controlled pilot with real-time monitoring and instant rollback capability. We stay on call for the first 14 days post-launch." },
    { step: "06", title: "Scale", desc: "Once the baseline is stable we expand coverage, tune performance, and add new automation use cases. Your system gets smarter every sprint." },
  ],
...
export function ServicePageClient({ slug }: { slug: string }) {
  ...
  const [sharedTestimonials, setSharedTestimonials] = useState<TestimonialsItem[]>([]);
